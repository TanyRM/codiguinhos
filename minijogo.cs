...
while (!shouldExit)
{
    ...
    {
        if (consumirAlimento(playerX, playerY, foodX, foodY))
        {
            ChangePlayer();
            ShowFood();
        }
...
Boolean consumirAlimento(int playerX, int playerY, int foodX, int foodY)
{
